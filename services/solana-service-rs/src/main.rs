        ...
        App::new()
            ...
            .service(
                web::scope("/actions")
                    ...
                    .service(routes::actions::post_uniswap_lp_positions)
                    .service(routes::actions::post_pools_launch_buy)
                    .service(routes::actions::post_pools_launch_sell)
                    .service(routes::actions::post_pools_launch_create)
                    ...
                    .service(routes::actions::post_morpho_supply)
                    ...
                    .service(routes::actions::post_opensea_mint)
