...
pub struct StakeParams {
    ...
    /// Stake account address generated by the CLIENT, forwarded to Jito's
    /// unstake builder so the wallet signs before the new account does.
    /// Marinade's own paths create no account and ignore it.
    #[serde(default)]
