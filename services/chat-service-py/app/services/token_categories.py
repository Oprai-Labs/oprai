...
def format_category_context_block(category: str, tokens: list[CategoryToken]) -> str:
    ...
    lines = [
        "[Category context — authoritative, this is your data source]",
        f"The user is asking about Solana {pretty}. You have NO tools",
        "available this turn — answer in PROSE using the list below.",
        "",
        "FORBIDDEN: refusing the question, hedging, asking for clarification,",
        "saying \"I cannot access\", \"I need more information\", \"my system",
        "does not have direct access to this data\", or any equivalent in any",
        "language. The list IS the data. Just answer in the user's language.",
        "",
        "Response shape:",
        "  - One short intro sentence in the user's language.",
        "  - One bullet per token below, in the order shown, formatted",
        "    `**SYMBOL** — short role description`.",
        "  - One closing sentence telling the user they can ask to swap",
        "    into any of these by naming it.",
        "",
        "The list:",
    ]
    for t in tokens:
