...
ACTION_TAGS: dict[str, frozenset[str]] = {
    ...
    "pools_buy":                     _A({"dex", "uniswap", "launchpad", "swap"}),
    "pools_sell":                    _A({"dex", "uniswap", "launchpad", "swap"}),
    "pools_launch":                  _A({"dex", "uniswap", "launchpad", "launch"}),
    "pons_buy":                      _A({"dex", "uniswap", "launchpad", "swap"}),
    "pons_sell":                     _A({"dex", "uniswap", "launchpad", "swap"}),
    "pons_launch":                   _A({"dex", "uniswap", "launchpad", "launch"}),
