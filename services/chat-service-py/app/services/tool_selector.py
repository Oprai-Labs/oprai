...
ACTION_TAGS: dict[str, frozenset[str]] = {
    ...
    "kamino_liquidity_deposit":   _A({"lending", "kamino", "liquidity"}),
    "kamino_liquidity_withdraw":  _A({"lending", "kamino", "liquidity"}),
    "kamino_liquidity_strategies": _A({"lending", "kamino", "liquidity", "analysis"}),
    ...
    "uniswap_launches":              _A({"dex", "uniswap", "analysis", "launchpad", "trending"}),
    "pools_buy":                     _A({"dex", "uniswap", "poolstrade", "launchpad", "swap"}),
    "pools_sell":                    _A({"dex", "uniswap", "poolstrade", "launchpad", "swap"}),
    "pools_launch":                  _A({"dex", "uniswap", "poolstrade", "launchpad", "launch"}),
    ...
    "opensea_accept_offer":          _A({"opensea", "nft"}),
    "opensea_list":                  _A({"opensea", "nft"}),
    "opensea_make_offer":            _A({"opensea", "nft"}),
...
QUERY_TAGS: dict[str, frozenset[str]] = {
    ...
    "opensea_mint_info": _A({"opensea", "nft", "analysis"}),
    "opensea_listings": _A({"opensea", "nft", "analysis"}),
    "opensea_trending": _A({"opensea", "nft", "trending", "analysis"}),
    "opensea_collection": _A({"opensea", "nft", "analysis"}),
    "opensea_nfts": _A({"opensea", "nft", "analysis"}),
    "opensea_nft": _A({"opensea", "nft", "analysis"}),
    "opensea_offers": _A({"opensea", "nft", "analysis"}),
    "opensea_activity": _A({"opensea", "nft", "analysis"}),
    "opensea_wallet_nfts": _A({"opensea", "nft", "portfolio"}),
    "simulate":       _A({"core"}),
    "whale":          _A({"analysis"}),
...
PROTOCOL_TO_TAGS: dict[str, frozenset[str]] = {
    ...
    # Robinhood launchpads — scope to their own actions (pools.trade vs Pons are
